...
class ZhihuSipder(CrawlSpider):
    ...
    def parse_people(self, response):
        ...
        # gender
        gender_pic = selector.xpath(
            '//div[@class="ProfileHeader-iconWrapper"][2]/*[name()="svg"]/@class').extract_first()
        gender = Gender.MALE
        if gender_pic and u'female' in gender_pic:
            gender = Gender.FEMALE

        # followee_count, follower_count
        ...
        print nickname, zhihu_id, bussiness, education, gender, followee_count, follower_count

        follow_urls = selector.xpath(
            '//a[@class="Button NumberBoard-item Button--plain"]/@href'
        ).extract()
